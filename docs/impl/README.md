...
| 1.39 | `done` | Brace calls & builtin sh/pw components (rule 22) | ymx-core, tests/ | [1.39-brace-calls.md](1.39-brace-calls.md) | 1.18, 1.26, 1.27, 1.31 |
| 1.40 | `done` | Fix key-suffix skip bug in resolve_property_set | ymx-core | [1.40-key-suffix-skip-fix.md](1.40-key-suffix-skip-fix.md) | 1.39 |
