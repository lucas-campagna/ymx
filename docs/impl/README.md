...
| 1.39 | `done` | External components via `_use` IPC declarations (core) | ymx-core, ymx-lib, ymx-cli | [1.39-ipc-core.md](1.39-ipc-core.md) | 1.38 |
| 1.40 | `in-progress` | IPC transports, structured mode & hooks (rule 21 extended) | ymx-core, ymx-lib | [1.40-ipc-transports-hooks.md](1.40-ipc-transports-hooks.md) | 1.39 |
...
| 1.42 | `done` | Fix key-suffix skip bug in resolve_property_set | ymx-core | [1.42-key-suffix-skip-fix.md](1.42-key-suffix-skip-fix.md) | 1.41 |
| 1.43 | `done` | Introduce ParsedKey for property-key modifier parsing | ymx-core | [1.43-parsed-key-refactor.md](1.43-parsed-key-refactor.md) | 1.42 |
