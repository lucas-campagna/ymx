...
short: "Index of versioned implementation milestones (1.1 – 1.23)"
description: |
...
| 1.25 | `planned` | `_use` directive (explicit file imports) | ymx-core, ymx-lib | [1.25-use-directive.md](1.25-use-directive.md) | 1.24 |
